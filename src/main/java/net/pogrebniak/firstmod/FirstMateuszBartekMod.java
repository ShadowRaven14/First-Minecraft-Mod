package net.pogrebniak.firstmod;
...
@Mod(FirstMateuszBartekMod.MOD_ID)
public class FirstMateuszBartekMod
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "firstmateuszbartekmod";
