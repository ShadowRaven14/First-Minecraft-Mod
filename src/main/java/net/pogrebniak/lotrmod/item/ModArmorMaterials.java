...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> MITHRIL_ARMOR_MATERIAL = register("mithril", Util.make(new EnumMap<>(ArmorItem.Type.class),
            attribute -> {
            ...
            }), 25, 6f, 0.5f, () -> ModItems.MITHRIL_INGOT.get());
    ...
    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
        ...
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(LotrMod.MOD_ID, name);
